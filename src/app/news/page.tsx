...
export default function NewsFeed() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-gray-900 mb-2">Clearline Daily</h1>
        <p className="text-gray-600">
          Expert analysis of prediction market movements across politics, crypto, economics, and more — what moved, why it moved, and whether you should believe it
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-6 mb-8 text-white">
        <div className="flex flex-col md:flex-row items-center gap-4">
          <div className="flex-1">
            <h2 className="text-xl font-semibold mb-2">Get Clearline Daily in your inbox</h2>
            <p className="text-blue-100">3–5 interpreted market stories delivered every morning, free.</p>
          </div>
          ...
          return (
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="ml-auto text-sm text-gray-500">{story.readTime} min read</div>
              </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-xs text-gray-500 mb-1">Current Odds</div>
              ...
              <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center justify-between">
                  <p className="text-sm text-blue-900">
                    <strong>Pro subscribers</strong> get access to full wallet breakdowns and historical data
                  </p>
